...
public class SecondNewsTopAdvertParser extends WebBaseParser {
    private static final String TAG = "SecondNewsTopAdvertParser";
    ...
    public void foundItemByClass(IWebTarget target, final Semaphore semaphore) {
        ...
        String findItemByClassName = String.format(Constants.JS_FUNCTION_FIND_ADVERT_TOP_BY_CLASS_NAME,
