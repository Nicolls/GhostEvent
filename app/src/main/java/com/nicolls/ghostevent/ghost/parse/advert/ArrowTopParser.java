...
public class ArrowTopParser extends WebBaseParser {
    private static final String TAG = "ArrowTopParser";

    public void foundItemByClass(IWebTarget target, Semaphore semaphore) {
        ...
        String findItemByClassName = String.format(Constants.JS_FUNCTION_FIND_ITEM_BY_CLASS_NAME,
